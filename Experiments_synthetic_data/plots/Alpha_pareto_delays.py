...
def Simulation_Alpha_pareto_delays():
    data1 = np.loadtxt('./data/Cum_RR_Alpha_pareto_delays.txt')
    data2 = np.loadtxt('./data/Cum_FR_Alpha_pareto_delays.txt')
    ...
    plt.annotate(r'$\times 10^{1}$',(0,30),(-5,50*(5400/5900)),fontsize = notationsize)
