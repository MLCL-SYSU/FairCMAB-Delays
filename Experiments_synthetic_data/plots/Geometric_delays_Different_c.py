...
def Simulation_Geometric_delays_Different_c():
    data1 = np.loadtxt('./data/Cum_RR_Geometric_delays_Different_c.txt')
    data2 = np.loadtxt('./data/Cum_FR_Geometric_delays_Different_c.txt')
    ...
    plt.xlim(0,None)
    plt.ylim(0,2800)
    plt.yticks(np.arange(0, 1100, 500))
    plt.xticks(np.arange(0, 20001, 5000))
    plt.tight_layout()
    fig.align_ylabels()
    plt.show()
    ...
    def formatnum2(x, pos):
        return "{:g}".format(x/10)
    plt.annotate(r'$\times 10^{4}$',(20000,0),(18800,60*(150/5900)),fontsize = notationsize)
    plt.annotate(r'$\times 10^{1}$',(0,110),(-5,60*(5400/5900)),fontsize = notationsize)
    formatter1 = FuncFormatter(formatnum1)
    formatter2 = FuncFormatter(formatnum2)
    ax.xaxis.set_major_formatter(formatter1)
    ax.yaxis.set_major_formatter(formatter2)
