...
def Simulation_Packet_loss_delays_Different_c():
    data1 = np.loadtxt('./data/Cum_RR_Packet_loss_delays_Different_c.txt')
    data2 = np.loadtxt('./data/Cum_FR_Packet_loss_delays_Different_c.txt')
    ...
    plt.grid(alpha=0.2)
    plt.legend(fontsize=Legendsize,loc = 'upper left',framealpha=0.4,bbox_to_anchor=(0, 0.95))
    ...
    def formatnum2(x, pos):
        return "{:g}".format(x/100)
    plt.annotate(r'$\times 10^{4}$',(20000,0),(18800,120*(150/5900)),fontsize = notationsize)
    plt.annotate(r'$\times 10^{2}$',(0,110),(-5,120*(5400/5900)),fontsize = notationsize)
    formatter1 = FuncFormatter(formatnum1)
    formatter2 = FuncFormatter(formatnum2)
    ax.xaxis.set_major_formatter(formatter1)
    ax.yaxis.set_major_formatter(formatter2)
    ...
    def formatnum2(x, pos):
        return "{:g}".format(x/1000)
    plt.annotate(r'$\times 10^{4}$',(20000,0),(18800,6300*(150/5900)),fontsize = notationsize)
    plt.annotate(r'$\times 10^{3}$',(0,4100),(-5,6300*(5400/5900)),fontsize = notationsize)
    formatter1 = FuncFormatter(formatnum1)
    formatter2 = FuncFormatter(formatnum2)
    ax.xaxis.set_major_formatter(formatter1)
    ax.yaxis.set_major_formatter(formatter2)
    ...
    plt.annotate(r'$\times 10^{1}$',(0,50),(-5,60*(5400/5900)),fontsize = notationsize)
    formatter1 = FuncFormatter(formatnum1)
    formatter2 = FuncFormatter(formatnum2)
    ax.xaxis.set_major_formatter(formatter1)
    ax.yaxis.set_major_formatter(formatter2)
    ...
    def formatnum2(x, pos):
        return "{:g}".format(x/1000)
    plt.annotate(r'$\times 10^{4}$',(20000,0),(18800,7000*(150/5900)),fontsize = notationsize)
    plt.annotate(r'$\times 10^{3}$',(0,4100),(-5,7000*(5400/5900)),fontsize = notationsize)
    formatter1 = FuncFormatter(formatnum1)
    formatter2 = FuncFormatter(formatnum2)
    ax.xaxis.set_major_formatter(formatter1)
    ax.yaxis.set_major_formatter(formatter2)
